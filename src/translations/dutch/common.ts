...
export const commonTranslations: Translations = {
  ...
  "Unlock the full potential of your fitness journey with our premium features.": "Ontgrendel het volledige potentieel van jouw fitnessreis met onze premium functies.",
  ...
  "Failed to start checkout process": "Kon het afrekenen niet starten",
  "Opening settings...": "Instellingen openen...",
  "Failed to open settings": "Kon instellingen niet openen",
  
  // Additional food translations
  ...
  "addedToMealPlan": "toegevoegd aan maaltijdplan",
  ...
  "Login To Save Nutrition Data": "Log in om voedingsgegevens op te slaan",
  "Today Meals": "Vandaag Maaltijden",
  "calendar": "Kalender",
  
  // Additional unit translations
  "gram": "gram",
